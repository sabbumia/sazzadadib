    ...
    <div className="relative min-h-screen flex items-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="text-center">
          ...
          {/* Main Content */}
          <div className="mb-8">
            <h1 className="text-5xl md:text-6xl font-bold mb-4 animate-fade-in text-white tracking-tight">
              {title}
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 mb-6 animate-fade-in delay-200 font-light">
              {subtitle}
            </p>
            {description && (
              <p className="text-base md:text-lg text-gray-400 max-w-2xl mx-auto leading-relaxed animate-fade-in delay-300">
                {description}
              </p>
            )}
          </div>
